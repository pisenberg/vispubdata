...
if (os.path.isfile(inputfilename)):
    ...
    for venue in listOfVenuesInData:
    ...
    # print(visPubDataAggregationDetailed)
    ...
    chart = alt.Chart(altairData, width={"step": 15}).mark_line().encode(
        x = alt.X('year:N', title=None).axis(labelAngle=-45),#domain=False, 
    ...
    ).configure_legend(columns=4, orient='bottom', direction='horizontal', titleLimit=0, labelLimit=0
